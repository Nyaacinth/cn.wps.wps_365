...
- WPS 365 可能会创建后台进程。在这种情况下你需要使用`flatpak kill cn.wps.wps_365`才能彻底关闭程序。或者您可以选择在 flatpak overrides （如通过 Flatseal ）中设置环境变量 KSO_KILL_CLOUDSVR_AFTERWARDS 的值为 1 以在 WPS 365 退出后自动杀死 wpscloudsvr。
